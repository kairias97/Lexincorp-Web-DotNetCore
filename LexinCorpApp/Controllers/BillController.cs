...
namespace LexincorpApp.Controllers
{
    public class BillController : Controller
    {
        ...
        public BillController(IItemRepository itemRepository, IActivityRepository activityRepository, IPackageRepository packageRepository, IBillableRetainerRepository billableRetainerRepository,
            IClientRepository clientRepository, IConfiguration configuration, Microsoft.AspNetCore.Hosting.IHostingEnvironment hostingEnvironment)
        {
        ...
        [Authorize]
        public IActionResult RenderBill(BillHeader billHeader)
        {
            var detalles = billHeader.BillDetails.Select(d => new
            {
                BillDetailType = d.BillDetailType,
                FixedAmount = d.FixedAmount,
                UnitRate = d.UnitRate,
                Quantity = d.Quantity,
                Subtotal = d.Subtotal,
